...
//       <div className="flex items-center justify-between mb-4">
//         <div className="flex items-center gap-2">
//           <div className={`w-2 h-2 rounded-full ${riskColor.dot} animate-pulse`}/>
//           <h2 className="text-sm font-semibold text-gray-300 uppercase
//                          tracking-widest">
//             Visual Brand Spoofing Analysis
//           </h2>
...
//                             bg-gray-800/80 border-b border-gray-700">
//               <span className="text-xs text-gray-400 font-medium">
//                 {panel.id === "heatmap"    && "Difference heatmap — red zones = tampered regions"}
//                 {panel.id === "suspicious" && "Suspicious page — what the user sees"}
//                 {panel.id === "real"       && `Real ${brand} page — the legitimate original`}
//               </span>
//               {panel.id === "heatmap" && (
//                 <span className="text-xs text-red-400 font-medium">
//                   {visualScan.diff_percentage}% pixels differ
...
//       {/* Three panel side by side option */}
//       <div className="mt-4 grid grid-cols-3 gap-2">
//         {panels.map(panel => (
//           <button
//             key={panel.id}
